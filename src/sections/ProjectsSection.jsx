...
import demi from '../assets/video/demi.mp4'
import labsPromo from '../assets/video/11labs.mp4'
    ...
    <section id="proyectos" className="section">
      ...
      <div className="projects-grid">
        <article className="project-card">
          <div className="project-head">
            <h3>DEMI AI PROMO</h3>
            <p className="project-description">{t.demi.description}</p>
            <div className="project-meta">
              <span>{t.deliveryLabel}</span>
              <strong>{t.demi.date}</strong>
            </div>
          </div>
          <div className="project-gallery">
            <div className="gallery-item gallery-item--media gallery-item--media-portrait2">
              <video className="reel-video" controls preload="metadata">
                <source src={demi} type="video/mp4" />
                {t.videoFallback}
              </video>
            </div>
          </div>
      ...
      <div className="projects-grid">
        <article className="project-card">
          <div className="project-head">
            <h3>11 LABS PROMO</h3>
            <p className="project-description">{t.labsPromo.description}</p>
            <div className="project-meta">
              <span>{t.deliveryLabel}</span>
              <strong>{t.labsPromo.date}</strong>
            </div>
          </div>
          <div className="project-gallery">
            <div className="gallery-item gallery-item--media gallery-item--media-portrait2">
              <video className="reel-video" controls preload="metadata">
                <source src={labsPromo} type="video/mp4" />
                {t.videoFallback}
              </video>
            </div>
          </div>
